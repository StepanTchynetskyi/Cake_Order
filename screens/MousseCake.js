...
const MousseCake = ({navigation}) => {
  ...
  const [heads, setHeads] = useState(['filling', 'glaze color']);
      ...
      {flag ? (
        <View style={styles.mainContainer}>
          ...
          <Text style={styles.mainLabel}>
            Choose mousse cake {heads[page - 1]}
          </Text>
                ...
                if (page == 2) {
                  navigation.navigate('ResultPage', {
                    ...
                    type: {
                      name: 'MousseCake',
                      URL:
                        'https://i.pinimg.com/564x/81/37/26/813726fc7150c2ed8a1b1814a074f81e.jpg',
                    },
                  });
                } else {
                  setPage(page + 1);
